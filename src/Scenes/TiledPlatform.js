class TiledPlatform extends Phaser.Scene {
    ...
    create() {
        ...
        this.diamondPowerUpVfxManager = this.add.particles('kenney_sheet', 215);
        this.coinPowerUpVfxManager = this.add.particles('kenney_sheet', 214);


        this.powerUpVfxEffect = this.diamondPowerUpVfxManager.createEmitter({
            follow: this.p1,
            quantity: 20,
        ...
        this.coinVfxEffect = this.coinPowerUpVfxManager.createEmitter({
            follow: this.p1,
            quantity: 20,
            scale: {start: 1.0, end: 0.0},  // start big, end small
            speed: {min: 50, max: 100}, // speed up
